...
#   ${variable}   → variable Terraform (interpolée à plan/apply)
#   $BASH_VAR     → variable bash (sans accolades pour éviter conflits)
#   $$(cmd)       → sous-commande bash → produit $(cmd) dans le script
# ═══════════════════════════════════════════════════════════════════
set -euo pipefail
